...
export const ru: Content = {
  ...
  hero: {
    ...
    tagline:
      "Строю LLM-агентов, которые превращают разрозненную инженерную документацию в машиночитаемые модели — чтобы команда доверяла результату, а не перечитывала сотни страниц спецификаций.",
    intro:
      "В АО «КАМА» (электромобиль «Атом») мои скиллы каждый день берут на себя рутину системного архитектора — от разбора спецификаций до формальной модели и документации. За этим — продуманная инженерия промптов, строгая валидация и человеко-в-контуре проверки на каждом шаге.",
  ...
  rolefit: {
    ...
    lead:
      "Не пересказ резюме. Слева — что обычно требуют от AI Engineer / Prompt Engineer, справа — где я это уже делал в production.",
    items: [
      {
      ...
      },
      {
        ...
        have:
          "Единый skill-интерфейс к PDF (pdfplumber, до 700 стр.), JSON (Devprom v2.1.V), Excel-матрицам сигналов, ARXML/AUTOSAR, DBC. ETL под агента: парсинг, структурирование, LLM-трансформация, валидация и коммит в Git.",
      },
      {
      ...
      },
      {
        ...
        have:
          "Чанкование длинных входов, кэширование промежуточных JSON, выбор модели по сложности задачи (Sonnet или Opus). Так держу баланс качества и стоимости.",
      },
    ],
  },
  tech: {
  ...
  projects: {
    ...
    lead: "От production-агента до пет-проектов. Каждый закрывает свою грань роли.",
    items: [
      {
        ...
        bullets: [
          ...
          "Structured output на Pydantic даёт гарантированно валидный DSL; синтаксис и доменные правила проверяются на каждом шаге.",
          "Замеренный эффект: конвертация SSTS PDF в модель — 16 ч против 10 мин (×96); полный отчёт трассируемости — 6 ч против 2 мин (×180).",
