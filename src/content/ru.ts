...
export const ru: Content = {
  ...
  hero: {
    ...
    tagline:
      "Беру сырой источник — PDF до 700 страниц, JSON, ARXML, Excel — и довожу его до валидной формальной модели и документации. Делаю это цепочками LLM-скиллов: каждый шаг даёт структурированный вывод и проходит валидацию.",
    intro:
